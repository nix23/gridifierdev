DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display = function($selectorRightSide, demoLayout) {
    var me = this;
    ...
    this._construct = function() {
        ...
        me._$view = $("<div/>").addClass(me._css.displayClass);
...
DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._createBlock = function(block, blockHeading, blockElement) {
...
DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._decorateBlocks = function() {
    this._$rightBlock.addClass(this._css.blockHorizontalMarginClass);
    this._$rightBlockElement.css("visibility", "hidden");
...
DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._launchAnimation = function() {
    this._isAnimating = true; 
    this._renderNextAnimationFrame();
}

DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._stopAnimation = function() {
    this._isAnimating = false;
...
DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._renderNextAnimationFrame = function() {
    ...
    if(this._isAnimating)
    {
        this._nextAnimationTimeout = setTimeout(
            $.proxy(DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._renderNextAnimationFrame, this),
            this._blockElementAnimationIntervalMs - 1
        );
    }
}

DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._renderNextLeftBlockElementFrame = function() {
    if(this._$leftBlockElement.css("visibility") == "hidden")
        this._$leftBlockElement.css("visibility", "visible");
    else if(this._$leftBlockElement.css("visibility") == "visible")
        this._$leftBlockElement.css("visibility", "hidden");
}

DemoLayoutBuilder.DemoLayout.GridControls.Selector.Toggle.Display.prototype._renderNextRightBlockElementFrame = function() {
    if(this._$rightBlockElement.css("visibility") == "hidden")
        this._$rightBlockElement.css("visibility", "visible");
    else if(this._$rightBlockElement.css("visibility") == "visible")
        this._$rightBlockElement.css("visibility", "hidden");
}